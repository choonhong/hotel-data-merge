...
const (
	...
	FieldImages = "images"
	// FieldBookingConditions holds the string denoting the booking_conditions field in the database.
	FieldBookingConditions = "booking_conditions"
