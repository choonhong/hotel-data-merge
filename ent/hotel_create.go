...
func (hc *HotelCreate) SetDestinationID(s string) *HotelCreate {
	hc.mutation.SetDestinationID(s)
	return hc
}
...
func (hc *HotelCreate) SetDetails(s string) *HotelCreate {
	hc.mutation.SetDetails(s)
	return hc
}
...
func (hc *HotelCreate) SetImages(d []domain.Image) *HotelCreate {
	hc.mutation.SetImages(d)
	return hc
}
...
func (hc *HotelCreate) check() error {
	...
	if _, ok := hc.mutation.City(); !ok {
		return &ValidationError{Name: "city", err: errors.New(`ent: missing required field "Hotel.city"`)}
	}
	if _, ok := hc.mutation.Country(); !ok {
		return &ValidationError{Name: "country", err: errors.New(`ent: missing required field "Hotel.country"`)}
	}
	if _, ok := hc.mutation.Details(); !ok {
		return &ValidationError{Name: "details", err: errors.New(`ent: missing required field "Hotel.details"`)}
	}
	if _, ok := hc.mutation.Amenities(); !ok {
		return &ValidationError{Name: "amenities", err: errors.New(`ent: missing required field "Hotel.amenities"`)}
	}
	if _, ok := hc.mutation.Images(); !ok {
		return &ValidationError{Name: "images", err: errors.New(`ent: missing required field "Hotel.images"`)}
	}
	if _, ok := hc.mutation.UpdatedAt(); !ok {
...
// SetDestinationID sets the "destination_id" field.
func (u *HotelUpsert) SetDestinationID(v string) *HotelUpsert {
...
// SetDetails sets the "details" field.
func (u *HotelUpsert) SetDetails(v string) *HotelUpsert {
	u.Set(hotel.FieldDetails, v)
	return u
}

// UpdateDetails sets the "details" field to the value that was provided on create.
func (u *HotelUpsert) UpdateDetails() *HotelUpsert {
	u.SetExcluded(hotel.FieldDetails)
	return u
}
...
// SetImages sets the "images" field.
func (u *HotelUpsert) SetImages(v []domain.Image) *HotelUpsert {
...
// SetDestinationID sets the "destination_id" field.
func (u *HotelUpsertOne) SetDestinationID(v string) *HotelUpsertOne {
...
// SetDetails sets the "details" field.
func (u *HotelUpsertOne) SetDetails(v string) *HotelUpsertOne {
	return u.Update(func(s *HotelUpsert) {
		s.SetDetails(v)
	})
}
...
// UpdateDetails sets the "details" field to the value that was provided on create.
func (u *HotelUpsertOne) UpdateDetails() *HotelUpsertOne {
	return u.Update(func(s *HotelUpsert) {
		s.UpdateDetails()
	})
}
...
// SetImages sets the "images" field.
func (u *HotelUpsertOne) SetImages(v []domain.Image) *HotelUpsertOne {
	return u.Update(func(s *HotelUpsert) {
		s.SetImages(v)
	})
}
...
// SetDestinationID sets the "destination_id" field.
func (u *HotelUpsertBulk) SetDestinationID(v string) *HotelUpsertBulk {
	return u.Update(func(s *HotelUpsert) {
		s.SetDestinationID(v)
	})
}
...
// SetDetails sets the "details" field.
func (u *HotelUpsertBulk) SetDetails(v string) *HotelUpsertBulk {
	return u.Update(func(s *HotelUpsert) {
		s.SetDetails(v)
	})
}
...
// UpdateDetails sets the "details" field to the value that was provided on create.
func (u *HotelUpsertBulk) UpdateDetails() *HotelUpsertBulk {
	return u.Update(func(s *HotelUpsert) {
		s.UpdateDetails()
	})
}
...
// SetImages sets the "images" field.
func (u *HotelUpsertBulk) SetImages(v []domain.Image) *HotelUpsertBulk {
	return u.Update(func(s *HotelUpsert) {
		s.SetImages(v)
	})
}
