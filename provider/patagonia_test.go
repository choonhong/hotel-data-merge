...
func TestPatagonia(t *testing.T) {
	...
	assert.True(t, reflect.DeepEqual([]schema.Image{
		...
		{URL: "https://d2ey9sqrvkqdfs.cloudfront.net/0qZF/4.jpg", Description: "Bathroom", Category: "rooms"},
		{URL: "https://d2ey9sqrvkqdfs.cloudfront.net/0qZF/0.jpg", Description: "RWS", Category: "amenities"},
		{URL: "https://d2ey9sqrvkqdfs.cloudfront.net/0qZF/6.jpg", Description: "Sentosa Gateway", Category: "amenities"},
	}, hotels[0].Images))
	...
	assert.True(t, reflect.DeepEqual([]schema.Image{
		{URL: "https://d2ey9sqrvkqdfs.cloudfront.net/YwAr/i10_m.jpg", Description: "Suite", Category: "rooms"},
		{URL: "https://d2ey9sqrvkqdfs.cloudfront.net/YwAr/i11_m.jpg", Description: "Suite - Living room", Category: "rooms"},
		{URL: "https://d2ey9sqrvkqdfs.cloudfront.net/YwAr/i57_m.jpg", Description: "Bar", Category: "amenities"},
	}, hotels[1].Images))
}
