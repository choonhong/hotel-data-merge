...
func TestPaperflies(t *testing.T) {
	...
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/0qZF/3.jpg", hotels[0].Images[1].URL)
	assert.Equal(t, "Double room", hotels[0].Images[1].Description)
	assert.Equal(t, "rooms", hotels[0].Images[1].Category)
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/0qZF/1.jpg", hotels[0].Images[2].URL)
	assert.Equal(t, "Front", hotels[0].Images[2].Description)
	assert.Equal(t, "site", hotels[0].Images[2].Category)
	...
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/Sjym/i93_m.jpg", hotels[1].Images[0].URL)
	assert.Equal(t, "Double room", hotels[1].Images[0].Description)
	assert.Equal(t, "rooms", hotels[1].Images[0].Category)
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/Sjym/i94_m.jpg", hotels[1].Images[1].URL)
	assert.Equal(t, "Bathroom", hotels[1].Images[1].Description)
	assert.Equal(t, "rooms", hotels[1].Images[1].Category)
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/Sjym/i1_m.jpg", hotels[1].Images[2].URL)
	assert.Equal(t, "Restaurant", hotels[1].Images[2].Description)
	assert.Equal(t, "site", hotels[1].Images[2].Category)
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/Sjym/i2_m.jpg", hotels[1].Images[3].URL)
	assert.Equal(t, "Hotel Exterior", hotels[1].Images[3].Description)
	assert.Equal(t, "site", hotels[1].Images[3].Category)
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/Sjym/i5_m.jpg", hotels[1].Images[4].URL)
	assert.Equal(t, "Entrance", hotels[1].Images[4].Description)
	assert.Equal(t, "site", hotels[1].Images[4].Category)
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/Sjym/i24_m.jpg", hotels[1].Images[5].URL)
	assert.Equal(t, "Bar", hotels[1].Images[5].Description)
	assert.Equal(t, "site", hotels[1].Images[5].Category)
	assert.Empty(t, hotels[1].BookingConditions)
	...
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/YwAr/i1_m.jpg", hotels[2].Images[0].URL)
	assert.Equal(t, "Suite", hotels[2].Images[0].Description)
	assert.Equal(t, "rooms", hotels[1].Images[0].Category)
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/YwAr/i15_m.jpg", hotels[2].Images[1].URL)
	assert.Equal(t, "Double room", hotels[2].Images[1].Description)
	assert.Equal(t, "rooms", hotels[1].Images[1].Category)
	assert.Equal(t, "https://d2ey9sqrvkqdfs.cloudfront.net/YwAr/i55_m.jpg", hotels[2].Images[2].URL)
	assert.Equal(t, "Bar", hotels[2].Images[2].Description)
	assert.Equal(t, "site", hotels[1].Images[2].Category)
	assert.Equal(t, []string{
